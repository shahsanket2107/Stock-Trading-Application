...
/**
 * This interface contains methods to fetch,store and display the AlphaVantage API results, to
...
public interface DataStoreFromApi {
   ...
   */
  Map<String, JsonNode> getApiData();

  /**
   * This method is used to fetch data from the API and store it in the Map of String and JSON
   * Node.
   *
  ...
  /**
   * This method is used to get the set of all tickers that have already been processed and stored
